...
### 루나 수집 기준 (인플루언서)
- ✅ 팔로워 1만~100만 / 인게이지먼트 3%+ / 뷰티·K-뷰티
- ✅ 프로필 공개 비즈니스 이메일
- ❌ 인게이지먼트 3% 미만 / 3개월 미업로드 / 타 브랜드 전속
...
### 대상: US/CA, 뷰티(K-beauty 해시태그 보유 우선), 팔로워 10K~100K
### 채널: 인스타 50%(50명/일) + 틱톡 50%(50명/일) = 매일 100명
### K-beauty 해시태그 우선: #kbeauty #kbeautyroutine #koreanskincare #koreanbeauty #kbeautyaddict #asianskincare
### 인스타 기준: 팔로워 10K~100K, 인게이지먼트 3%+, 최근 30일 포스팅, 공개 비즈니스 이메일
### 틱톡 기준: 팔로워 10K~100K, 평균 조회 5만+, 최근 30일 포스팅, 공개 이메일
### 제외: K-beauty 해시태그 없음 / 비공개 / 기업계정 / 이미 DB에 있음 / 이메일 없음
### 스케줄: 금~월 자정 수집 → 월요일 09:00 CEO 승인 요청
